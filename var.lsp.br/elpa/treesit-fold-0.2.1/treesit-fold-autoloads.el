...
With prefix ARG, enable Global Treesit-Fold mode if ARG is positive; otherwise,
disable it.
...
Treesit-Fold mode is enabled in all buffers where `treesit-fold--trigger' would
do it.
...
With prefix ARG, enable Global Treesit-Fold-Indicators mode if ARG is positive;
